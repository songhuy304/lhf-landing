      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-green-800 font-medium tracking-wider">BOOKING</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4 mb-6">ご予約・お問い合わせ</h2>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">ご予約方法</h3>
                <p className="text-gray-600 mb-8">
                  下記のいずれかの方法でお気軽にご連絡ください。 24時間以内にお返事いたします。
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <Button
                    ...
                    onClick={() => window.open("https://m.me/your-page", "_blank")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => window.open("https://instagram.com/your-account", "_blank")}
                  >
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-600 text-sm">10:00 - 20:00（最終受付19:00）</p>
          ...
          <div className="mt-12 text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">初回限定特典</h3>
            <p className="text-gray-600 mb-6">
              初回ご来店のお客様には、ハンドケア付きジェルネイルを特別価格でご提供いたします。
              <br />
              この機会にぜひお試しください。
            </p>
            <div className="inline-block bg-red-100 text-red-800 font-bold py-2 px-6 rounded-full">
              初回30%OFF ¥4,900 → ¥3,430
            </div>
          </div>
        </div>
      </div>
